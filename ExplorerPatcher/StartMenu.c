...
extern void *memmem(void *haystack, size_t haystacklen, void const *needle, size_t needlelen);
...
LRESULT CALLBACK OpenStartOnCurentMonitorThreadHook(int code, WPARAM wParam, LPARAM lParam)
{
    if (code == HC_ACTION && wParam) {
        MSG *msg = (MSG *)lParam;
        if (GetSystemMetrics(SM_CMONITORS) >= 2 && msg->message == WM_SYSCOMMAND &&
            ...
            FARPROC SHRegGetValueFromHKCUHKLMFunc = GetProcAddress(hModule,
            "SHRegGetValueFromHKCUHKLM"); if (!SHRegGetValueFromHKCUHKLMFunc ||
            ...
            if (!bMonitorOverride) {
                ...
                mod.hMonitor = NULL;
                EnumDisplayMonitors(NULL, NULL, &ExtractMonitorByIndex, (LPARAM)&mod);
...
OpenStartOnCurentMonitorThread(OpenStartOnCurentMonitorThreadParams *unused)
{
    ...
    HHOOK g_ProgHook = SetWindowsHookEx(WH_GETMESSAGE, OpenStartOnCurentMonitorThreadHook, NULL, progThread);
    printf("Progman hook: %p\n", (void *)g_ProgHook);
    ...
    return printf("Ended \"Open Start on current monitor\" thread.\n");
}

DWORD
OpenStartAtLogonThread(OpenStartAtLogonThreadParams *unused)
{
    ...
    return printf("Ended \"Open Start at Logon\" thread.\n");
}
...
DWORD WINAPI HookStartMenu(HookStartMenuParams *params)
{
    ...
    while (TRUE) {
        ...
        LPVOID lpRemotePath = VirtualAllocEx(hProcess, NULL, MAX_PATH, MEM_COMMIT | MEM_RESERVE, PAGE_READWRITE);
        ...
        if (!WriteProcessMemory(hProcess, lpRemotePath, (void *)params->wszModulePath, MAX_PATH, NULL)) {
        ...
        *(LPVOID *)(memmem(shellcode, sizeof(shellcode), &pattern, sizeof(uintptr_t))
        )       = (LPVOID)((uintptr_t)params->proc - (uintptr_t)params->hModule);
        ...
        *(LPVOID *)(memmem(shellcode, sizeof(shellcode), &pattern, sizeof(uintptr_t))) = GetLastError;
        ...
        if (!WriteProcessMemory(hProcess, lpRemoteCode, shellcode, sizeof(shellcode), NULL)) {
...
WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented(void *instanceof_WindowsUdk_UI_Shell_ITaskbarSettings)
{
    return E_NOTIMPL;
}

static ULONG STDMETHODCALLTYPE
WindowsUdk_UI_Shell_ITaskbarSettings_AddRefRelease(void *instanceof_WindowsUdk_UI_Shell_ITaskbarSettings)
{
    return 1;
}
...
static void *instanceof_WindowsUdk_UI_Shell_ITaskbarSettings6Vtbl[41] = { // : IInspectableVtbl
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,          WindowsUdk_UI_Shell_ITaskbarSettings_AddRefRelease,
    WindowsUdk_UI_Shell_ITaskbarSettings_AddRefRelease,           WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,          WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings6_GetEffectiveSearchMode, WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,          WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,          WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,          WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,          WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
...
static void *instanceof_WindowsUdk_UI_Shell_ITaskbarSettingsVtbl[41] = { // : IInspectableVtbl
    WindowsUdk_UI_Shell_ITaskbarSettings_QueryInterface,    WindowsUdk_UI_Shell_ITaskbarSettings_AddRefRelease,
    WindowsUdk_UI_Shell_ITaskbarSettings_AddRefRelease,     WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_GetAlignment_Left, WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_GetLocation_Left,  WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_GetSearchMode,     WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,    WindowsUdk_UI_Shell_ITaskbarSettings_NotImplemented,
...
BOOL NeedsRo_PositionStartMenuForMonitor(HMONITOR hMonitor, HDC unused1, LPRECT unused2, StartMenuPositioningData *data)
{
    ...
    if (SUCCEEDED(hr))
        hr = WindowsCreateStringReference(
            L"WindowsUdk.UI.Shell.TaskbarLayout", 33, &hstringHeader_of_WindowsUdk_UI_Shell_TaskbarLayout,
            &hstring_of_WindowsUdk_UI_Shell_TaskbarLayout
        );
    if (SUCCEEDED(hr))
        hr = RoGetActivationFactory(
            hstring_of_WindowsUdk_UI_Shell_TaskbarLayout, &IID_WindowsUdk_UI_Shell_TaskbarLayoutStatics,
            &pTaskbarLayoutFactory
        );
    if (SUCCEEDED(hr)) {
        // hr = (*(HRESULT(**)(INT64, INT64*))(*(INT64*)pTaskbarLayoutFactory +
        // 48))(pTaskbarLayoutFactory, &v12);
    ...
    if (SUCCEEDED(hr)) {
        ...
        hr = pTaskbarLayout->lpVtbl->QueryInterface(
            pTaskbarLayout, &IID_WindowsUdk_UI_Shell_ITaskbarLayoutManager, &pTaskbarLayoutManager
        );
    }
    if (SUCCEEDED(hr)) {
        // hr = (*(HRESULT(**)(INT64, HMONITOR, INT64(***)(), INT64))(*v13 + 48 + (sizeof(uintptr_t) *
        // data->operation)))(v13, hMonitor, &p, 0);
        ...
        // registry:
        // HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\WindowsRuntime\ActivatableClassId\WindowsUdk.UI.Shell.TaskbarLayout
        if (data->location) {
    ...
    if (hstring_of_WindowsUdk_UI_Shell_TaskbarLayout) {
        HRESULT res = WindowsDeleteString(hstring_of_WindowsUdk_UI_Shell_TaskbarLayout);
...
DWORD
GetStartMenuPosition(FARPROC SHRegGetValueFromHKCUHKLMFunc_local)
{
    DWORD dwSize      = sizeof(DWORD);
    DWORD dwTaskbarAl = 1;

    INT_PTR(FAR WINAPI *func)(TCHAR *, TCHAR *, DWORD, LPVOID, LPDWORD, LPDWORD) = SHRegGetValueFromHKCUHKLMFunc_local;

    if (!func || func(
                     TEXT("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Advanced"), TEXT("TaskbarAl"),
                     SRRF_RT_REG_DWORD, NULL, &dwTaskbarAl, &dwSize
                 ) != ERROR_SUCCESS)
        dwTaskbarAl = 1;
